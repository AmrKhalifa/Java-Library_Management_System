...
import view.masterPanel.EventsAndListeners.RentBookListener;

public class BookRenter extends JDialog {
	...
	private RentBookEvent event;
	private RentBookListener listener;

	public BookRenter(MasterPanel parent) {
	...
	private void makeConfirmationPanel() {
		...
		submitButton.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				...
				try {
					event = new RentBookEvent(this, bookCodeField.getText(), memberCodeField.getText(), rentingDate);
	...
	public void setListener(RentBookListener listener) {
